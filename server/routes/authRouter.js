...
import { profileUpdate, updateExistingProfile, deleteAvatar, blockUser, getUserByUsername,reportUser} from '../controllers/userController.js'
...
.post('/report-user', verifyToken, reportUser)
